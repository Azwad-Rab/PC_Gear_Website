        ...
        <div class="center_prod_box_big">
          <div class="contact_form">
			<form action="process1.php" method="post">
                    <p class="field">
                        <label for="fname"><strong>User_Name</strong></label><br><br>
                       <input type="text" name="fname" id="User_Name" placeholder="Name">
                    </p>
                    <br>
                    <p class="field">
                        <label for="pass"><strong>Password</strong></label><br><br>
