            ...
            <div id="main_content">
                <div id="menu_tab">
                    ...
                    <ul class="menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="contact.php" class="nav4">Contact Us</a></li>
                        <li class="divider"></li>
                        <li><a href="log_in_new.php" class="nav6">Log In</a></li>
                        <li class="divider"></li>
        ...
        <div class="center_prod_box_big">
          <div class="contact_form">
		       <form action="login.php" method="POST">
                    <p class="field">
                        <label for="fname"><strong>Enter User Name</strong></label><br><br>
                       <input type="text" name="fname" id="fname" placeholder="User Name">
                    </p>
                    <br>
                    <p class="field">
                        <label for="pass"><strong>Enter Password</strong></label><br><br>
